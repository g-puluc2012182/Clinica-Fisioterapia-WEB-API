...
INSERT INTO `categoria` VALUES (1,'DR.ALVARADO'),(2,'DR.LUIS'),(3,'Dr.Juan'),(10,'DR.Hugo'),(7,'Dr.Mario'),(11,'DR.Jorge');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `agendain6am`.`categoria_BEFORE_INSERT` BEFORE INSERT ON `categoria` FOR EACH ROW
BEGIN
	INSERT INTO Historial (accion) VALUES('INSERT-DOCTOR');
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `agendain6am`.`categoria_BEFORE_UPDATE` BEFORE UPDATE ON `categoria` FOR EACH ROW
BEGIN
	INSERT INTO Historial (accion) VALUES('UPDATE-DOCTOR');
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `agendain6am`.`categoria_BEFORE_DELETE` BEFORE DELETE ON `categoria` FOR EACH ROW
BEGIN
	INSERT INTO Historial (accion) VALUES('DELETE-DOCTOR');
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `cita` VALUES (1,'11-10-2018','Clinica Fisioterapia JAG','Terapia',32),(5,'2017-04-04','Ciudad de Guatemala','Cita de Negociaciones',46);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `agendain6am`.`contacto_BEFORE_INSERT` BEFORE INSERT ON `contacto` FOR EACH ROW
BEGIN
	INSERT INTO Historial (accion) VALUES('INSERT-PACIENTE');
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `agendain6am`.`contacto_BEFORE_UPDATE` BEFORE UPDATE ON `contacto` FOR EACH ROW
BEGIN
	INSERT INTO Historial (accion) VALUES('UPDATE-CITA');
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `agendain6am`.`contacto_BEFORE_DELETE` BEFORE DELETE ON `contacto` FOR EACH ROW
BEGIN
	INSERT INTO Historial (accion) VALUES('DELETE-PACIENTE');
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `historial` VALUES (53,'INSERT-USUARIODETALLE','2017-06-30 03:40:40'),(176,'DELETE-TAREA','2018-11-07 00:17:00'),(177,'DELETE-TAREA','2018-11-07 00:17:02'),(143,'INSERT-TAREA','2018-03-12 04:00:33'),(144,'UPDATE-TAREA','2018-03-12 04:01:39'),(158,'INSERT-PACIENTE','2018-11-06 01:50:34'),(159,'UPDATE-TAREA','2018-11-06 01:57:25'),(160,'DELETE-TAREA','2018-11-06 01:57:33'),(161,'DELETE-TAREA','2018-11-06 01:57:39'),(162,'DELETE-TAREA','2018-11-06 01:57:41'),(163,'DELETE-TAREA','2018-11-06 01:57:51'),(164,'DELETE-TAREA','2018-11-06 01:57:53'),(165,'DELETE-TAREA','2018-11-06 01:57:54'),(166,'DELETE-TAREA','2018-11-06 01:57:56'),(167,'INSERT-TAREA','2018-11-06 02:03:44'),(168,'INSERT-TAREA','2018-11-06 02:05:16'),(169,'UPDATE-DOCTOR','2018-11-06 02:08:59'),(170,'UPDATE-CITA','2018-11-07 00:05:19'),(171,'DELETE-CITA','2018-11-07 00:08:49'),(172,'DELETE-CITA','2018-11-07 00:08:50'),(173,'DELETE-CITA','2018-11-07 00:08:52'),(174,'UPDATE-TAREA','2018-11-07 00:10:38'),(175,'UPDATE-CITA','2018-11-07 00:11:17');
...
INSERT INTO `tarea` VALUES (1,'Terapia','Clinica Fisioterapia JAG','11-10-2018','11-10-2018',' Espera');
...
INSERT INTO `usuario` VALUES (1,'Gpuluc','1234'),(2,'Lperez','1234'),(3,'Jhernandez','1234'),(4,'jl','1234'),(5,'Luis','1234'),(6,'Lpuluc','@geovanny'),(7,'@Lpuluc','hola'),(8,'@Puluc','administrador'),(9,'@Administrador','1234'),(10,'@Lm','administrador'),(11,'Jhuertas','1234'),(12,'ggg','123');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ELIMINAR_PACIENTE`(IN `nombre1` VARCHAR(30), IN `apellido1` VARCHAR(30), IN `direccion1` VARCHAR(30), IN `telefono1` VARCHAR(12), IN `correo1` VARCHAR(40), IN `idCategoria1` INT, IN `idUsuario1` INT)
BEGIN
	INSERT INTO contacto (nombre, apellido, direccion, telefono, correo, idCategoria) VALUES(nombre1, apellido1, direccion1, telefono1, correo1, idCategoria1);
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `INGRESAR_PACIENTE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `INGRESAR_PACIENTE`(IN `nombre1` VARCHAR(30), IN `apellido1` VARCHAR(30), IN `direccion1` VARCHAR(30), IN `telefono1` VARCHAR(12), IN `correo1` VARCHAR(40), IN `idCategoria1` INT, IN `idUsuario1` INT)
BEGIN
	INSERT INTO contacto (nombre, apellido, direccion, telefono, correo, idCategoria) VALUES(nombre1, apellido1, direccion1, telefono1, correo1, idCategoria1);
END ;;
DELIMITER ;
...
-- Dump completed on 2018-11-06 18:41:50
